...
- [`install-apt-packages.yml`](install-apt-packages.yml): instala herramientas base, `pyenv` con sus dependencias de compilación y Docker con Buildx y Compose desde los repositorios APT de Ubuntu en `localhost`.
