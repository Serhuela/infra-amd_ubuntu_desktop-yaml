...
- [`install-snap-packages.yml`](install-snap-packages.yml): instala Bitwarden, Termius (`termius-app`), OpenCode (`opencode`) y Visual Studio Code (`code`). OpenCode y Visual Studio Code usan confinamiento `classic`.
